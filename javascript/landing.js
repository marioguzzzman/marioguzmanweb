...
window.addEventListener('load', function () {
  ...
  t4.to(".snippetglitch", 0.1, {
      skewX: 700,
      ease: Power4.easeInOut
    })
    .to(".snippetglitch", 0.04, {
      skewX: 0,
      ease: Power4.easeInOut
    })
    .to(".snippetglitch", 0.02, {
      x: -20
    })
    .to(".snippetglitch", 0.03, {
      x: 0
    })
    .add("split", 0)
    .to(".snippetglitch", 0.02, {
    ...
    .add("split", 0)
    .to(".snippetglitch", 0.01, {
      scaleY: .4,
      ease: Power4.easeInOut
    })
    .to(".snippetglitch", 0.0, {
      scaleY: 1,
      ease: Power4.easeInOut
    })
});
